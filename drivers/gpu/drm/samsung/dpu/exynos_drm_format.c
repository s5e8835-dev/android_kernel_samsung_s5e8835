...
#ifndef IDMA_IMG_FORMAT_ARGB_FP16
#define IDMA_IMG_FORMAT_ARGB_FP16		(0)
#endif

#ifndef IDMA_IMG_FORMAT_ABGR_FP16
#define IDMA_IMG_FORMAT_ABGR_FP16		(0)
#endif
...
const struct dpu_fmt *dpu_find_fmt_info(u32 fmt)
{
	...
	DRM_INFO("%s: can't find format(%p4cc) in supported format list\n",
			__func__, &fmt);
